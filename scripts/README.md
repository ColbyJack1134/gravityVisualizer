...
The preview script writes eight-second 1080p GIFs to `dist/media/`, four-second 480×270 gallery copies under 2 MB to `assets/previews/`, and 128×128 idle and Legacy thumbnails to `wallpaper/`. `--start` selects a different music excerpt. Rebuild both wallpaper packages after generating their thumbnails.
