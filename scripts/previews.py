...
def gif(target, transform, fps, seconds):
    filters = f'fps={fps},{transform},split[frames][colors];[colors]palettegen=reserve_transparent=0[palette];[frames][palette]paletteuse=dither=none'
...
gif(gallery / (scene + '.gif'), 'scale=640:360:flags=lanczos', 20, 4)
