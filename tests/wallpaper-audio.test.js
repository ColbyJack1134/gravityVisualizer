...
run(3, samples(4, 0.8));
assert.ok(spectrum.bass > 0.5 && spectrum.kick < 0.001, 'Held bass must stop retriggering kicks');
assert.ok(spectrum.shake > 0.05 && spectrum.shake < 0.2, 'Held host bass keeps a restrained rumble');
